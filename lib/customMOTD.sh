...
sshIP=$(sudo netstat -tnpa | grep 'ESTABLISHED.*ssh ' | grep -v "127.0.0.1" | awk '{ print $4 }' | cut -f1 -d':' | sort | uniq)
...
\033[1;34m"Tunneling on IP...: "\033[0;37m${sshIP}
\033[1;34m"Uptime............: "\033[0;37m${up}
\033[1;34m"Hostname..........: "\033[0;37m$(hostname -f)
\033[1;34m"Current SSID......: "\033[0;37m${currentSSID}
\033[1;34m"Using WiFi Gateway: "\033[0;37m${gatewaywifi}
